# Hybrid Cache for Amazon S3 Testing Guide
...
3. **Hybrid Cache for Amazon S3 running**:
   ```bash
...
4. **Connection refused**:
   - Check proxy is running on expected ports (HTTP: 80, HTTPS: 443, TLS proxy: 3129 if enabled)
